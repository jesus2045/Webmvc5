...
namespace Webmvc5.Models
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idDepartamento,nombre,ubicacion,centroCosto")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idDepartamento,nombre,ubicacion,centroCosto")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
